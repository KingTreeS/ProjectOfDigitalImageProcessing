...
public:
	...
	/** 对图像进行取反，当前点值为a，取反值为：255 - a */
	bool lightReverse(const char* fileName, int quality_scale);
...
private:
    ...
    void _inverseColorSpace(int xPos, int yPos, char* yData, char* cbData, char* crData);
